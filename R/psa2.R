...
#' CARET PSA Biomarker data - Etzioni substudy (454 control patients; 229 patients with prostate cancer)
#'
#' \itemize{
#'   \item id patient id; sequential, randomly assigned
#'   \item d Prostate Ca (0 no 1 yes). Non-cancer patients are controls matched to cases on age and # sample.
...
#' \url{http://mdm.sagepub.com/content/19/3/242.abstract}
#' @keywords data
NULL
